...
import { Building2, User, FileText, Calendar, Check, AlertCircle } from 'lucide-react';
...
const MembershipForm = () => {
  // Step tracking: 0 = company info, 1 = contact, 2 = business, 3 = membership, 4 = docs, 5 = done
  ...
  return (
    <div className="w-full">
      {/* Step Navigation Bar with labels */}
        ...
        {stepLabels.map((label, idx) => (
          <div key={idx} className="flex items-center">
            ...
            {idx < stepLabels.length - 1 && (
              <div className={`w-5 h-1 ${step > idx ? 'bg-green-500' : 'bg-gray-200'} rounded transition-all`}></div>
            )}
          </div>
        ))}
      </div>
      ...
      {/* Form Step Panels */}
      <div className="bg-white border border-gray-200 rounded-2xl shadow p-6 md:p-8 mb-4">
        {step === 0 && (
          <>
            <div className="flex items-center gap-3 mb-6">
              <Building2 className="w-5 h-5 text-blue-700" />
              <h2 className="text-lg font-semibold text-blue-700">{stepLabels[0]}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* -- Company Information Form Inputs -- */}
              <div>
                ...
                />
                {errors.companyName && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.companyName}</span>}
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700">Company Type *</label>
                <select
                  name="companyType" value={formData.companyType} onChange={handleInputChange}
                ...
                {errors.companyType && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.companyType}</span>}
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700">Business Category *</label>
                <select
                  name="businessCategory" value={formData.businessCategory} onChange={handleInputChange}
                ...
                {errors.businessCategory && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.businessCategory}</span>}
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                />
                {errors.companyAddress && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.companyAddress}</span>}
              </div>
              <div>
              ...
              <div>
                ...
                />
                {errors.companyPhone && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.companyPhone}</span>}
              </div>
              <div>
                ...
                />
                {errors.companyEmail && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.companyEmail}</span>}
              </div>
            </div>
        ...
        {step === 1 && (
          <>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-green-700">{stepLabels[1]}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* -- Contact Person Information Form Inputs -- */}
              <div>
                ...
                />
                {errors.contactPersonName && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.contactPersonName}</span>}
              </div>
              <div>
                ...
                />
                {errors.designation && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.designation}</span>}
              </div>
              <div>
                ...
                />
                {errors.contactEmail && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.contactEmail}</span>}
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="+880-XXX-XXXXXXX"
                />
                {errors.contactPhone && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.contactPhone}</span>}
              </div>
            </div>
        ...
        {step === 2 && (
          <>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-purple-700">{stepLabels[2]}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* -- Business Details Form Inputs -- */}
              <div>
              ...
              <div className="md:col-span-2">
                ...
                />
                {errors.businessDescription && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.businessDescription}</span>}
              </div>
            </div>
            <div className="mt-8 flex justify-between">
              <button
        ...
        {step === 3 && (
          <>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-orange-700">{stepLabels[3]}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* -- Membership Information Form Inputs -- */}
              <div>
                ...
                {errors.membershipType && <span className="text-xs text-red-600 flex items-center gap-1 mt-1"><AlertCircle className="w-4 h-4" />{errors.membershipType}</span>}
              </div>
              <div>
        ...
        {step === 4 && (
          <>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-teal-700">{stepLabels[4]}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* -- Supporting Documents Form Inputs -- */}
              <div>
