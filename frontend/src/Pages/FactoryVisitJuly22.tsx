...
// Import all images from assets/visit/visit1 (adjust names if needed)
...
const FactoryVisitJuly22: React.FC = () => {
          ...
          <div className="mb-10">
            <div className="relative w-full max-w-xl mx-auto">
              <img
                ...
                alt={`Factory Visit July 2022 - Image ${currentIndex + 1}`}
            ...
            <div className="flex gap-2 justify-center mt-4">
              {carouselImages.map((img, idx) => (
                <img
                  key={idx}
                  src={img}
                  alt={`Factory Visit July 2022 thumbnail ${idx + 1}`}
...
export default FactoryVisitJuly22;